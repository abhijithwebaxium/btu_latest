          ...
          {tab === 'transcripts' && (
            ...
            >
              ...
              <div className="grid grid-cols-4 gap-4">
                {[
                  { label: 'Transfer Subjects', value: prevSubs.length,                                                                           color: 'text-white' },
                  { label: 'Transfer Credits',  value: prevCr,                                                                                    color: 'text-amber-400' },
                  { label: 'Reappear Subjects', value: reappearSubs.length,                                                                       color: 'text-orange-400' },
